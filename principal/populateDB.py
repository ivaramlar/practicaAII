...
def populateOccupations():
    ...
    TEXT_FILE = ROOT_DIR / path / "u.occupation"
...
def populateGenres():
    ...
    TEXT_FILE = ROOT_DIR / path / "u.genre"
...
def populateUsers():
    ...
    TEXT_FILE = ROOT_DIR / path / "u.user"
...
def populateMovies():
    ...
    TEXT_FILE = ROOT_DIR / path / "u.item"
...
def populateRatings(u,m):
    ...
    TEXT_FILE = ROOT_DIR / path / "u.data"
